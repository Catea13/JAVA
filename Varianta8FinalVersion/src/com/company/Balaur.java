...
/**Constructor implicit(fara parametri)**/
    ...
    public void setFromKeyBoard() {
        ...
        for (int i = 0; i < nrTotaldeCapete; i++) {
            int temp;
            do {
                System.out.print("Introduceti coeficientul de intelect al capetelui " + (i+1) + ": ");
                temp = scanner.nextInt();
            }
            while (temp > 250 || temp < 20);
            this.IQAlCapetelor[i] = temp;
        }
        ...
        this.greutatea = scanner.nextFloat();
